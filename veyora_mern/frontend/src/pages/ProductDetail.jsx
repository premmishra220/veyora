...
const ProductDetail = () => {
  ...
  // Safe variables for Title and Image
  ...
  return (
    <div className="product-detail-wrapper" style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      ...
      <div style={{ color: '#a1a1aa', marginBottom: '20px', fontSize: '0.95rem' }}>
        <Link to="/" style={{ color: '#f97316' }}>Home</Link> / <Link to="/shop" style={{ color: '#f97316' }}>Shop</Link> / {product.category} / <span style={{ color: '#fff' }}>{title}</span>
      </div>
      ...
      <div className="product-detail">
        ...
        <div className="detail-info">
          ...
          <h2 style={{ fontSize: '2.8rem', marginBottom: '10px' }}>{title}</h2>
